    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-1 ml-2 mt-2">
                <a href="REQUEST.php"><img src="21.png" style="height: 70px;"/></a>
            </div>
                ...
                <div class="card-body">
                    <div class="container table">
                        ...
                        <div class="text-right">
                            <button type="button" class="btn btn-primary col-sm-2 mt-1" onclick="messagebox()" >DONE</button>
                        </div>
                    </div>
                </div>
            </div>
